...
/**
 * Компоненты, представляющие сведения о пункте маршрута транспортного средства
 * 
 * <p>Java class for ItineraryPointDetailsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ItineraryPointDetailsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ItineraryPointDetailsType", propOrder = {
    "unifiedCountryCode",
    "placeName",
    "objectOrdinal",
    "customsOfficeCode",
...
public class ItineraryPointDetailsType {
