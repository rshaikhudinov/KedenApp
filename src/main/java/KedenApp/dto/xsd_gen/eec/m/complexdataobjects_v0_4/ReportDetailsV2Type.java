...
/**
 * Компоненты, представляющие детализированную информацию об отчете с группировкой значений показателей
 * 
 * <p>Java class for ReportDetailsV2Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReportDetailsV2Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:EEC:M:ComplexDataObjects:v0.4.14}ObsSeriesDetails" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ReportDetailsV2Type", propOrder = {
    "reportKindCode",
    "reportName",
...
public class ReportDetailsV2Type {
    ...
    @XmlElement(name = "ObsSeriesDetails", required = true)
    protected List<ObsSeriesDetailsType> obsSeriesDetails;
    ...
    /**
     * Gets the value of the obsSeriesDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the obsSeriesDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObsSeriesDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ObsSeriesDetailsType }
     * 
     * 
     */
    public List<ObsSeriesDetailsType> getObsSeriesDetails() {
        if (obsSeriesDetails == null) {
            obsSeriesDetails = new ArrayList<ObsSeriesDetailsType>();
        }
        return this.obsSeriesDetails;
    }
