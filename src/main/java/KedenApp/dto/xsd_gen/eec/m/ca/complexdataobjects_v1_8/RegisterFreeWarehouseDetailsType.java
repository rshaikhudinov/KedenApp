...
/**
 * компоненты, представляющие сведения о владельце свободного склада
 * 
 * <p>Java class for RegisterFreeWarehouseDetailsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RegisterFreeWarehouseDetailsType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:EEC:M:CA:ComplexDataObjects:v1.8.1}FreeWarehouseDetails" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "RegisterFreeWarehouseDetailsType", propOrder = {
    "providedInformationCountryCode",
    "registerOrganizationDetails",
    "registerDocumentDetails",
    "customsOfficeCode",
    "freeWarehouseDetails",
    "activityStartDate",
    "activityEndDate",
    "resourceItemStatusDetails"
})
public class RegisterFreeWarehouseDetailsType {
    ...
    @XmlElement(name = "FreeWarehouseDetails", required = true)
    protected List<WarehouseDetailsType> freeWarehouseDetails;
    ...
    /**
     * Gets the value of the freeWarehouseDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the freeWarehouseDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFreeWarehouseDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WarehouseDetailsType> getFreeWarehouseDetails() {
        if (freeWarehouseDetails == null) {
            freeWarehouseDetails = new ArrayList<WarehouseDetailsType>();
        }
        return this.freeWarehouseDetails;
    }
