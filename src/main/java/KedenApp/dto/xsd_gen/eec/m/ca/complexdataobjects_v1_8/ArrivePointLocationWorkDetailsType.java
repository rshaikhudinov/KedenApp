...
/**
 * компоненты, представляющие сведения о режиме работы подразделения таможенного органа, совершающего таможенные операции в месте прибытия (убытия) товаров
 * 
 * <p>Java class for ArrivePointLocationWorkDetailsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ArrivePointLocationWorkDetailsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ArrivePointLocationWorkDetailsType", propOrder = {
    "workTimeCode",
    "workTimeDescriptionText",
    "workScheduleDetails"
})
public class ArrivePointLocationWorkDetailsType {
