...
/**
 * Строка символов обозначающая уникальный идентификационный таможенный номер, присвоенный юридическому или физическому лицу
 * 
 * <p>Java class for CAUniqueCustomsNumberIdType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CAUniqueCustomsNumberIdType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "CAUniqueCustomsNumberIdType", propOrder = {
    "value"
})
public class CAUniqueCustomsNumberIdType {
