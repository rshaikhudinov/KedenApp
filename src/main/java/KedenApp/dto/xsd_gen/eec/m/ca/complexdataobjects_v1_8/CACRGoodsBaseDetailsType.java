...
/**
 * компоненты, представляющие базовые сведения о товаре ТПО
 * 
 * <p>Java class for CACRGoodsBaseDetailsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CACRGoodsBaseDetailsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CACRGoodsBaseDetailsType", propOrder = {
...
@XmlSeeAlso({
    CRGoodsInfoDetailsType.class
})
public class CACRGoodsBaseDetailsType {
